 ...
 */
const CustomerDetails = ({ userContext, environment }: ExtensionContextValue) => {
    ...
    >
      ...
      <Box css={{ stack: 'y', rowGap: 'large' }}>
        ...
        <Box>
          ...
          <Inline>
            <Link external href="https://docs.stripe.com/stripe-apps/components">
              UI Components.
            </Link>
          </Inline>
        </Box>
        ...
        <Box>
          ...
          <Link external href="https://stripe.com/docs/stripe-apps" target="_blank">
            Stripe Apps docs
          </Link>
          .
        </Box>
        ...
        <Box css={{ color: 'info' }}>
          Edit the file{' '}
          <Inline css={{ fontFamily: 'monospace' }}>src/views/CustomerDetails.tsx</Inline>{' '}
