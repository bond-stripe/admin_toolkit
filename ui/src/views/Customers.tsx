import { Box, ContextView, Divider, Inline, Link } from '@stripe/ui-extension-sdk/ui';
  ...
  return (
    ...
    >
      <Box css={{ stack: 'y', rowGap: 'large' }}>
        <Box>
          Click on a customer (or create a new one) to navigate to that customer&rsquo;s
          detail view.
        </Box>
        <Divider />
        <Box css={{ color: 'info' }}>
